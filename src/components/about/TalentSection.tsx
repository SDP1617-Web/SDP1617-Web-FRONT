...
const TALENTS = [
  {
    title: 'Ownership',
    description:
      '내 파트의 업무가 끝났다고 책임마저 끝나는 건 아니에요. 기획안, 디자인 시안, 코드 한 줄이 모여 결국 하나의 살아있는 서비스로 연결되어야 하니까요. 내 역할에만 갇히지 않고 어떻게든 되게 만들 방법을 함께 고민하며, 마침내 유저가 만나는 프로덕트로 완성해 내는 끈기를 기대해요.',
  },
  {
    title: 'Openness',
    description:
  ...
  },
  {
    title: 'Impact',
    description:
      "기획자의 논리, 디자이너의 시각, 개발자의 기술이 하나로 모여 '지속가능성'이라는 뚜렷한 목표를 향해 달려가요. 세상에 필요한 가치를 깊게 파고들며, 실제로 작동하는 임팩트를 함께 만들어갈 분을 기다려요.",
  },
]
