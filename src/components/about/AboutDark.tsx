...
const emblems = [
  {
    ...
    description:
      '지속가능성 관점에서 사회 문제를 발견하고,\n데스크 리서치 바탕의 체계적인 기획으로\n그 문제의 해결방안을 찾아가요.\n현업의 서비스 기획 프로세스를 따라가며,\n새로운 툴과 방법론에 도전적으로 부딪히고\n익혀나가요.',
  },
  {
    title: '디자인팀',
    subTitle: 'Branding to Experience',
    description:
      '지속가능한 미래를 위한 새로운 서비스의\n브랜드 방향성을 구축하고, 사용자의 관점에서\n서비스 경험과 화면을 설계해요.\n브랜딩과 UX/UI 디자인을 통해 서비스 전반의\n디자인을 만들어가며, 기획·테크팀과 협업하여\n실제 프로덕트로 발전시켜 나가요.',
  },
  {
    title: '테크팀',
    subTitle: 'Building Tomorrow with Code',
    description:
      'SDGs 기반의 사회적 문제를 해결하기 위해,\nIT 웹·앱 서비스를 구현해요.\n아이디어를 설계·개발·배포까지 연결하며\n다양한 문제를 해결하는 개발자로 성장해요.',
  },
]
